...
export default {
  data() {
    return {
      ...
      tableData1: [
        {
          pgsj: '2020.12.1 11:23',
          jhwcsj: '2020.12.1 18:00',
          pgdh: '20202120101',
          rwmc: '换表',
        },
      ],
